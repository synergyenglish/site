...
// Animations
import { revealGrid, alertColorAnimation } from "./CoursesAnimation";
...
// Assets
import kidWhiteMedium from "/assets/Others/Kid Illu White-medium.svg";
import bentoBanner from "/assets/Others/Bento Banner.svg";
...
export default function CoursesGrid() {
  ...
  const handleOpenModal = (card) => {
    openModal(CoursesModal, { content: card, closeModal }, card.title);
  };
    ...
    const context = gsap.context(() => {
      const gridTimeline = gsap.timeline({
        scrollTrigger: {
          ...
          start: "top 60%", // Adjust trigger position
          end: "bottom 20%",
      ...
      gridTimeline.add(revealGrid(bentoRefs.current));

      // Alert Color Animation
      alertColorAnimation(alertIconBgRef.current, gridRef.current);
    }, gridRef);
  ...
  return (
    <section
      id="courses"
      className="section section--medium--padding section--white"
    >
      <div className="container">
        <div className={styles.courses}>
          ...
          {/* Grid */}
          <div ref={gridRef} className={`bento-grid ${styles.courses_grid}`}>
            <div
              className={`grid-item item-1 ${styles.bentoWrapper}`}
              ref={(el) => (bentoRefs.current[0] = el)}
            >
              <div
                className={`${styles.contentWrapper} ${styles.orangeGrid}`}
                onClick={() => handleOpenModal(COURSES[0])}
              >
                <img src={kidWhiteMedium} alt="Smily Emotes Illustrations" />
                <div className={styles.textWrapper}>
                  <h4>Young Learners English Course</h4>
                  {/* <p>
                    Whether your child is just beginning their English journey
                    or preparing for international certifications, we’re here to
                    support their growth every step of the way.
                  </p> */}
                  <p className="lan">
                    YLE Program ဟာ Cambridge ကနေ အခြေခံကစပြီး စနစ်တကျ
                    ရေးဆွဲထားတဲ့ Program တစ်ခုဖြစ်ပြီးတော့ Level တစ်ခုချင်းစီမှာ
                    Reading, Writing, Speaking, Listening (4) Skills လုံးကို
                    သင်ယူရမှာ ဖြစ်တဲ့အပြင် level တစ်ခုချင်းအလိုက် သိရမယ့်
                    Vocabularly,Grammar နဲ့ စာမေးပွဲဖြေဆိုပုံတွေကို သင်ယူ
                    ရမှာဖြစ်တဲ့အတွက် အခုမှ အဂ်လိပ်ဘာသာစကားကို စလေ့လာတဲ့
                    ကလေးတွေအတွက် အခြေခံကနေ စနစ်တကျ တက်မြောက်သွားမှာ ဖြစ်သလို
                    နောက်ထပ်အဆင့်မြင့်တဲ့ level တွေကို သင်ယူတဲ့အခါမှာလဲ
                    အခြေခံပိုင်နိုင်ပြီးသားဖြစ်တဲ့အတွက်
                    ​အခက်အခဲအများကြီးမရှိပဲသင်ယူနိုင်မှာဖြစ်ပါတယ်
                  </p>
            ...
            <div
              ...
              className={`grid-item item-2 ${styles.bentoWrapper}`}
            >
              <div className={`${styles.contentWrapper} ${styles.bannerGrid}`}>
                <div
                  className={`${styles.illustration}`}
                  style={{ "--aspect-ratio": "16/9" }}
                >
                  <img src={bentoBanner} alt="Smily Emotes Illustrations" />
                </div>
                <div className={styles.illustrationShader}></div>
                <div className={styles.textWrapper}>
                  <h4>Kids from age</h4>
                  <h1 className="h1_decorative">6 - 16</h1>
                </div>
              </div>
            </div>
            <div
              ref={(el) => (bentoRefs.current[2] = el)}
              className={`grid-item item-3 ${styles.bentoWrapper}`}
            >
              <div
                className={`${styles.contentWrapper} ${styles.yellowGrid}`}
                onClick={() => handleOpenModal(COURSES[1])}
              >
                <div className={styles.textWrapper}>
                  <h4>General English Course</h4>
                  <p>
                    Our lessons are structured through interactive lessons,
                    real-life scenarios, and engaging activities, students build
                    confidence and fluency while expanding their vocabulary and
                ...
                >
                  <g clipPath="url(#clip0_147_35)">
                    <rect
                      y="194.776"
                      width="250"
                      height="250"
                      transform="rotate(-45 0 194.776)"
                      fill="#F5F6F7"
                    />
                  </g>
                  <defs>
                    <clipPath id="clip0_147_35">
                      <rect width="264" height="214" fill="white" />
                    </clipPath>
                  </defs>
                </svg>
              </div>
            ...
            <div
              ...
              className={`grid-item item-4 ${styles.bentoWrapper}`}
            >
              {/* Alert Icon */}
              <svg
              ...
              <div
                className={`${styles.contentWrapper} ${styles.blueGrid}`}
                onClick={() => handleOpenModal(COURSES[2])}
              >
                <div className={styles.textWrapper}>
                  <h4>Art and Extracarriculars</h4>
                  <p>
                    At Synergy English, learning goes beyond textbooks! Our
                    extracurricular clubs provide students with fun and engaging
                    opportunities to explore their interests, develop new
                    skills, and express their creativity—all while improving
                    their English naturally.
                  </p>
                  <div className={styles.buttonWrapper}>
                    <Button type="">Learn More</Button>
                  </div>
                ...
                <svg
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <g clipPath="url(#clip0_147_40)">
                    <circle cx="181" cy="181" r="160" fill="#F5F6F7" />
                  </g>
                  <defs>
